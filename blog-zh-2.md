...
> 官网：https://jadeai.cturing.cn/zh | GitHub：https://github.com/amiibot/JadeAI
...
- **自托管部署**：通过 Docker 一行命令部署（`docker run -d -p 3000:3000 -e AUTH_SECRET=<密钥> -e LOCAL_AUTH_USERS_JSON='[{"username":"jade","name":"Jade Family","passwordHash":"scrypt$16384$8$1$replace-salt$replace-derived-key"}]' -v jadeai-data:/app/data csania/jadeai:latest`），也可以本地 clone 源码开发。
